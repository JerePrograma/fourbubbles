...
class ConcurrentCompatibilityIT extends PostgresIntegrationTestSupport {
    ...
    private String evaluateAfterSignal(CountDownLatch start, String token, String orderA, String orderB) {
        try {
    ...
    private String createClassifiedOrder(String token, String label) throws Exception {
        ...
        performJson(post("/orders/{id}/reception", orderId)
                .header("Authorization", bearer(token))
                .header("Idempotency-Key", "compat-concurrent-" + UUID.randomUUID())
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {
    ...
    private String login() throws Exception {
        ...
        String password = "Compatibility-test-password";

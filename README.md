...
> Versión funcional: **0.4.4**. Última actualización documental: **2026-07-26**.
...
- configuración administrativa de máquinas y programas desde una pantalla exclusiva de `ADMIN`.
...
8. Como `ADMIN`, abrir **Configuración** para actualizar máquinas o programas existentes.
9. Abrir **Métricas** para revisar la operación del período.
10. Resolver calidad: `PASS → FOLDING`; `REWASH → REWASH_REQUIRED`.
11. Registrar pagos y consultar auditoría.
...
- [Release 0.4.4](docs/RELEASE_0_4_4.md)
